...
describe("RegisterForm", () => {
    ...
    it("RegisterForm muestra un error por campo si faltan datos obligatorios (valida AC-06)", async () => {
        ...
        expect(
            await screen.findByText("La clave es requerida")
        ).toBeInTheDocument();
    ...
    it("test-block2-validation-message-clave-longitud", async () => {
        ...
        expect(
            await screen.findByText("La clave debe tener al menos 8 caracteres")
        ).toBeInTheDocument();
    });
    ...
    it("test-block2-validation-message-claves-no-coinciden", async () => {
        ...
        expect(
            await screen.findByText("Las claves no coinciden")
        ).toBeInTheDocument();
        expect(mockedRegisterUser).not.toHaveBeenCalled();
    });
    ...
    it("test-block2-register-labels-clave", async () => {
        ...
        expect(
            screen.queryByText("Contraseña", { exact: false })
    ...
    it("test-block2-field-spacing-13px", () => {
        ...
        expect(screen.getByTestId("register-form-fields")).toHaveClass(
            "space-y-[13px]"
        );
    });
    ...
    it("test-block2-button-spacing-13px", () => {
        ...
        expect(
            button.closest('[data-testid="register-form-actions"]')
        ).toHaveClass("space-y-[13px]");
    ...
    it("test-block2-input-radius-1rem", () => {
        ...
        expect(screen.getByLabelText("Confirmar clave")).toHaveClass(
            "rounded-[1rem]"
        );
    });
    ...
    it("test-block2-banner-spacing-13px", async () => {
        ...
        expect(
            banner.closest('[data-testid="register-form-actions"]')
        ).toHaveClass("space-y-[13px]");
        expect(container.querySelector("form")).toHaveClass("space-y-[13px]");
    });
