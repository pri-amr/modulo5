```
/ddw-validate-spec docs/ddw/specs/spec-FEAT-007.md — PASSED
────────────────────────────────────────────────────────────────
  ✅ F-SPEC-01: all 12 FR from the PRD are referenced by a block
  ✅ F-SPEC-02: all 13 AC from the PRD are named by at least one test
  ...
  ⚠️ W-SPEC-02: large block, consider splitting: Block 2 (RegisterForm: ancho fijo, espaciado, centrado y radios) (3 files, 629 words), Block 3 (Loader: overlay de pantalla completa (cambio global)) (7 files, 622 words), Block 4 (AuthLayout: ancho responsive de la tarjeta) (2 files, 1765 words)
