```
/ddw-validate-prd docs/ddw/prd/prd-FEAT-008.md — PASSED
────────────────────────────────────────────────────────────────
  ✅ F-PRD-08: all mandatory sections present and written in
  ✅ F-PRD-05: 18 FR, 3 NFR, 19 AC — unique, gapless
  ...
  ⚠️ W-PRD-06: 19 acceptance criteria, over the 5–7 that Scope Control names as the point to reassess. Legitimate if it was decided; a sub-ticket of a split arriving here means the split did not make the parts smaller than the whole
