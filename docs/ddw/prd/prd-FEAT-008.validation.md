...
────────────────────────────────────────────────────────────────
  ...
  ✅ F-PRD-05: 17 FR, 3 NFR, 18 AC — unique, gapless
  ...
  ⚠️ W-PRD-06: 18 acceptance criteria, over the 5–7 that Scope Control names as the point to reassess. Legitimate if it was decided; a sub-ticket of a split arriving here means the split did not make the parts smaller than the whole
