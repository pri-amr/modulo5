...
────────────────────────────────────────────────────────────────
  ...
  ✅ F-PRD-05: 8 FR, 1 NFR, 9 AC — unique, gapless
  ...
  ⚠️ W-PRD-06: 9 acceptance criteria, over the 5–7 that Scope Control names as the point to reassess. Legitimate if it was decided; a sub-ticket of a split arriving here means the split did not make the parts smaller than the whole
